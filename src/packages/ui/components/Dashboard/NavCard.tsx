...
export default function ({ selected, setSelected }: propType) {
    return <div className="bg-white rounded-lg overflow-hidden ">
        <div className="relative pb-20 mb-20">
            <div className="z-10 top-0 left-0 bg-darkslateblue">
                <img src="resource/profile-1.png" alt="profile" />
            </div>
        ...
        <div>
            ...
            <div className={`flex border-t px-8 py-4 ${selected === 'logout' ? 'text-mediumturquoise' : 'text-slate-500'}  items-center cursor-pointer hover:text-mediumturquoise`} onClick={() => setSelected("logout")}>
                <div>
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
